...
int Index_KMP(String S, String T, int pos);/* 返回子串T在主串S中第pos个字符之后的位置。若不存在，则函数返回值为0。 T非空，1≤pos≤StrLength(S)。 */
void get_nextval(String T, int *nextval);/* 求模式串T的next函数修正值并存入数组nextval */
